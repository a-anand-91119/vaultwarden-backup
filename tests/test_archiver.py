...
def test_create_success_no_encrypt(config_no_encrypt, mock_shutil, mock_os, tmp_path):
...
def test_create_success_with_encrypt(config_encrypt_with_key, mock_run_command, mock_shutil, mock_os, tmp_path):
...
def test_create_fail_source_not_dir(config_no_encrypt, mock_os, tmp_path):
...
def test_create_fail_encrypt_no_key(config_encrypt_no_key, mock_shutil, mock_os, tmp_path):
...
def test_create_fail_make_archive_exception(config_no_encrypt, mock_shutil, mock_os, tmp_path):
...
def test_create_fail_gpg_exception(config_encrypt_with_key, mock_run_command, mock_shutil, mock_os, tmp_path):
...
def test_decrypt_success(config_encrypt_with_key, mock_run_command, mock_os):
...
def test_decrypt_skip_not_gpg(config_encrypt_with_key, mock_run_command, mock_os):
...
def test_decrypt_fail_gpg_exception(config_encrypt_with_key, mock_run_command, mock_os):
...
def test_extract_success(config_no_encrypt, mock_shutil, mock_os):
...
def test_extract_fail_exception(config_no_encrypt, mock_shutil, mock_os):
