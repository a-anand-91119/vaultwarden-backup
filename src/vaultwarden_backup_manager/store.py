...
class BackupStore:
    ...
    def __init__(self, config):
        ...
        if self.dest_type != 'local':
             logger.warning(f"Destination type '{self.dest_type}' is not fully supported. Only local operations available.")
        ...
        try:
            ...
            for file_path, backup_date in sorted_parsed_files:
                ...
                if keep:
                    ...
                    if is_daily_candidate: # Check if it was kept as daily
                       daily_kept += 1
